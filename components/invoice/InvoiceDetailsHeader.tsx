  ...
  return (
    <div className="flex flex-col items-center justify-between p-6 space-y-6 bg-gray-800 rounded-lg sm:p-8 md:flex-row md:space-x-4 md:space-y-0 xl:px-12 ">
      <div className="flex items-center w-full font-semibold md:w-auto">
        <p className="text-white lg:text-lg">Status</p>
        <button
          disabled
      ...
      <div className="flex flex-wrap justify-center gap-6 font-semibold text-white sm:justify-between sm:space-x-4 md:inline">
        <button
          onClick={handleEditButton}
          className="px-4 py-2 duration-75 ease-in-out rounded-2xl bg-brand-500 hover:bg-brand-600 md:px-5 md:py-3"
        >
          Edit
        </button>
        ...
        <button
          ...
          className="px-4 py-2 duration-75 ease-in-out bg-red-500 rounded-2xl hover:bg-red-600 disabled:cursor-not-allowed disabled:bg-gray-700 md:px-5 md:py-3"
        >
          Delete
        </button>
        <button
          ...
          className="px-4 py-2 bg-green-600 rounded-2xl hover:bg-green-700 disabled:cursor-not-allowed disabled:bg-gray-700 md:px-5 md:py-3"
        >
          Mark as Paid
        </button>
      </div>
